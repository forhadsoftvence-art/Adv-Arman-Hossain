...
(async()=>{
 ...
 await page.waitForFunction(()=>document.querySelector('[data-count="700"]').textContent==='৭০০+');
 assert.deepEqual(await page.locator('[data-count]').allTextContents(),['১৫+','৭০০+','৯৫%','২৪-৭']);
 ...
 assert.deepEqual(await rp.locator('[data-count]').allTextContents(),['১৫+','৭০০+','৯৫%','২৪-৭']);
 ...
 assert.deepEqual(await np.locator('[data-count]').allTextContents(),['১৫+','৭০০+','৯৫%','২৪-৭']);
